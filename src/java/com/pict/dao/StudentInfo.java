...
public class StudentInfo {
    ...
    public int getApproved(String subname, String username) throws ClassNotFoundException, SQLException {
        ...
        String query1 = "select Approved from SubmissionTicket where SubjectCode=(select SubjectCode from SubjectTable where SubjectName='" + subname + "') and RollNo=" + username + ";";
    ...
    public ResultSet studAssign(String userid, String subject) throws ClassNotFoundException, SQLException {
        ...
        String stud_query1 = "select AssignmentName from AssignmentExist where GroupName=(select GroupName from GroupTable where GroupCode=(select GroupID from GroupStart where StartRollNo <= " + userid + " and EndRollNo>=" + userid + ") and UserID=(select UserID from UserInfo where SubjectCode=(select SubjectCode from SubjectTable where SubjectName='" + subject + "') and GroupCode=(select GroupID from GroupStart where StartRollNo <=" + userid + " and EndRollNo>=" + userid + ")));";
    ...
    public ResultSet datequery(String userid, String subject, String asg_name) throws ClassNotFoundException, SQLException {
        ...
        String stud_query2 = "select ScheduledDate,SubmissionDate , Marks from " + asg_name + " where RollNo = " + userid + " and Approved =1;";
