...
while( i < count) {
   ...
   GroupStartRollNo =  Integer.parseInt(GROUPSTART.getJSONObject("").getJSONArray("").getJSONObject(i).getString("GroupStartRollNo"));
        GroupEndRollNo =  Integer.parseInt(GROUPEND.getJSONObject("").getJSONArray("").getJSONObject(i).getString("GroupEndRollNo"));
